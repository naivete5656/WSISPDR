function [selBasis candiBasis]=BasisBestSelectionLocalFirst(img,F,basisList,kernelList,M,preBasis,debug)
...
candiBasis = find(inner_norm>=mean(inner_norm));
selBasis=pos; 