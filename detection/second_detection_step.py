...
from train_second import TrainNetSecond
...
train_path = Path(f"../outputs/detection/test18/single/test18/{plot_size}/pred")
mask_path = train_path.parent.joinpath('gt')
val_path = Path("../outputs/detection/test18")
val_mask_path = Path("../outputs/detection/test18")
